...
def test_guest_can_add_product_to_basket(browser):
    ...
    page.open()
    page.add_to_basket()
    page.correct_success_message()
    page.correct_book_price()
    page.correct_book_name()
...
class TestUserAddToBasketFromProductPage():
    ...
    def test_user_can_add_product_to_basket(self, browser):
        ...
        self.product_page.correct_success_message()
        self.product_page.correct_book_price()
        self.product_page.correct_book_name()
